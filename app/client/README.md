...
│   │   ├── Logout.js                # Configuration entry point
...
```
 |- containers
    |- AsyncRouteComponent
       |- Logout.js          // Wrap the route component as async component
       |- RouteComponent.js // The route component
```

The `Logout.js` will be:
...
By the way, if you want to use your based style or a vendor CSS framework, just import it through the `./src/containers/App/Logout.js` file, for example:
